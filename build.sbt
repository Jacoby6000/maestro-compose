...
lazy val root =
  (project in file("."))
    ...
    .aggregate(core, midi, `composition-dsl`)
    .dependsOn(core, midi, `composition-dsl`)
...
lazy val commonSettings = {
  ...
  Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.specs2" %% "specs2-core" % "3.8.9" % "test" // for testing
    ),
    scalacOptions ++= Seq(
